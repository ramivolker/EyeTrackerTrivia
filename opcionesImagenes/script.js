...
casos.push(caso = new nivel("¿Cuál es el continente más grande del mundo?","Asia","África","izquierda","asia.webp","africa.webp"));
...
casos.push(caso = new nivel("¿En qué país se encuentra el monte de Machu Picchu?","Perú","México","izquierda","machupicchuperu.webp","machupicchumexico.webp"));
...
casos.push(caso = new nivel(`¿Qué famoso filósofo griego dijo la frase "Solo sé que no sé nada"?`,"Sócrates","Aristóteles","izquierda","socrates.jpg","aristoteles.webp"));
...
casos.push(caso = new nivel(`¿Cuál es el país más pequeño del mundo?`,"Ciudad del Vaticano","Maldivas","izquierda","vaticano.jpg","maldivas.webp")); 
